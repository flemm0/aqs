with
    ...
    reporting_area_ids as (
        select distinct
            reportingareaname as reporting_area, reportingareaid as reporting_area_id
    ...
    reporting_area_id_added as (
        ...
        join
            reporting_area_ids
            on columns_renamed_nulls_coalesced.reporting_area
            = reporting_area_ids.reporting_area
    ),
